...
namespace MapStudio
{
    public class MainWindow : UIFramework.MainWindow
    {
        ...
        //Program settings
        private UI.GlobalSettings GlobalSettings;
        //Plugin settings
        ...
        public override void OnLoad()
        {
            ...
            GlobalSettings = UI.GlobalSettings.Load();
        ...
        private void Init()
        {
            ...
            SaveMenu = new MenuItem($"Save To Mod Folder", IconManager.SAVE_ICON, () =>
            {
                if (Workspace.ActiveWorkspace != null)
                    Workspace.ActiveWorkspace.SaveFileToModFolder(SampleMapEditor.GlobalSettings.ModOutputPath);
            })
            { Shortcut = "Ctrl+S" };
        ...
        //     var settings = UI.GlobalSettings.Current;
...
// #endif
        ...
        private void LoadFileFormat(string filePath)
        {
            ...
            bool createNew = !UI.GlobalSettings.Current.Program.UseSameWorkspace;
