...
namespace UIFramework
{
    ...
    public class Framework : GameWindow
    {
        ...
        private static string Name = "LAS Level Editor";

        public Framework(MainWindow window, GraphicsMode gMode, string asssemblyVersion,
            string name = "LAS Level Editor", int width = 1280, int height = 720) : base(width, height, gMode,
